-- Create users table
-- This script creates a table named users with id, email, name, and country attributes.
...
-- The country is an enumeration of countries (US, CO, TN) and cannot be null. The default value is US.
